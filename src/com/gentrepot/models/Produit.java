...
public class Produit {
    ...
    public Produit(String reference, String libelle) {
        this.reference = reference;
        this.libelle = libelle;
    }

    public Produit (String reference, String libelle, int quantiteStock, String classe, int quantiteStockSecurite, double dernierPrixAchat, double tva, double dimension, String description, String typeDeConditionnement, double prixVente) {
        this.reference = reference;
        this.libelle = libelle;
        this.quantiteStock = quantiteStock;
        this.classe = classe;
