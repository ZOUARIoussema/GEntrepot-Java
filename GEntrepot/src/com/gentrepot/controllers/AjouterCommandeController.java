...
public class AjouterCommandeController implements Initializable {
   ...
   private  CommandeVente commandeVenteG = new CommandeVente();
    ...
    commandeVenteG.setId(serviceCommandeVente.recupere()+1);
     ...
     public static int  nbSumsung;
     
     public static int nbIphone;
    ...
    private void selectArticle(MouseEvent event) {
        ...
        produitG = tableViewProduit.getSelectionModel().getSelectedItem();
         ...
         if( tableViewProduit.getSelectionModel().getSelectedItem().getLibelle().equals("sumsung")){
            
            nbSumsung++;
            
            
        }
        System.out.println("sumsung="+nbSumsung);
        
        
        if( tableViewProduit.getSelectionModel().getSelectedItem().getLibelle().equals("Iphone 11")){
            
            nbIphone++;
            
            
        }
        System.out.println("iphone="+nbIphone);
